        ...
        children=[
            html.H4(className='what-is',
                    children='FinPattern'),
                            ...
                            options=[{'label': f, 'value': f}
                                    for f in stocks],
                            value='TSLA', searchable=True, style={'width': '65%'}),
            dcc.Dropdown(id='stock_metric_dropdown',value=['TSLA.Open', 'TSLA.High', 'TSLA.Close','TSLA.Low'],multi=True, clearable=True, style={
                            'width': '100%'}),
            ...
            '''),         html.Div(
                html.Img(
                    ...
                    src = f'{parent_img_path}/assets/proj_structure.png', 
                    style={'width': "50%"}
                ),
